...
export default function OracionHacenSufrirScreen() {
  return (
    <>
      <Stack.Screen
        options={{
      ...
      <ScrollView style={styles.container}>
        <View style={styles.content}>
          <View style={styles.headerCard}>
            <Text style={styles.mainTitle}>Por los que nos hacen sufrir</Text>
          </View>

          <View style={styles.prayerCard}>
            <Text style={styles.sectionTitle}>Oración</Text>
            <Text style={styles.prayer}>
              Dios de amor, que mediante el precepto de la caridad{'\n'}
