...
export default function OracionEleccionPapaObispoScreen() {
  return (
    <>
      <Stack.Screen
        options={{
          title: 'Elección del Papa o del Obispo',
          headerStyle: {
      ...
      <ScrollView style={styles.container}>
        <View style={styles.content}>
          <View style={styles.headerCard}>
            <Text style={styles.mainTitle}>Para la elección del Papa o del Obispo</Text>
          </View>
