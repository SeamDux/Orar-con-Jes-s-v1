...
export default function OracionInternetScreen() {
  return (
    <>
      <Stack.Screen
        options={{
          title: 'Oración antes de conectarse a Internet',
          headerStyle: {
