    ...
    <>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.content}>
          ...
          <Text style={[styles.devocionItemTitulo, {fontSize: 17, color: '#222', textAlign: 'justify', marginBottom: 16, fontStyle: 'italic'}]}>“Nadie puede decir: 'Jesús es Señor', sino por influjo del Espíritu Santo” (1 Colosenses 12, 3). La Iglesia nos invita a invocar al Espíritu Santo como Maestro interior de la oración cristiana.</Text>
          <Text style={[styles.devocionItemTitulo, {fontSize: 17, color: '#222', textAlign: 'justify', marginBottom: 16, fontStyle: 'italic'}]}>“Cada vez que en la oración nos dirigimos a Jesús, es el Espíritu Santo quien, con su gracia preveniente, nos atrae al camino de la oración. Por eso, la Iglesia nos invita a implorar todos los días al Espíritu Santo, especialmente al comenzar y terminar cualquier acción importante”.</Text>
          <Text style={[styles.devocionItemTitulo, {fontSize: 17, color: '#222', textAlign: 'justify', marginBottom: 16, fontStyle: 'italic'}]}>“La forma tradicional para pedir el Espíritu Santo es invocar al Padre por medio de Cristo nuestro Señor para que nos dé el Espíritu Consolador (cf. Lucas 11,13). Jesús insiste en esta petición en su Nombre en el momento mismo en que promete el don del Espíritu de Verdad (cf. Juan 14, 17; 15, 26; 16, 13). Pero la oración más sencilla y la más directa es también la más tradicional: 'Ven, Espíritu Santo', y cada tradición litúrgica la ha desarrollado en antífonas e himnos. (CEC 2670-2671; 2681).</Text>
