  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
          ...
          <Link href="/resumen-doctrina" asChild>
            <TouchableOpacity style={styles.menuItem}>
          ...
          <Link href="/vida-cristiana" asChild>
            <TouchableOpacity style={styles.menuItem}>
          ...
          <Link href="/oficio-del-dia" asChild>
            <TouchableOpacity style={styles.menuItem}>
          ...
          <Link href="/oraciones-noche" asChild>
            <TouchableOpacity style={styles.menuItem}>
          ...
          <Link href="/devociones-jesus" asChild>
            <TouchableOpacity style={styles.menuItem}>
          ...
          <Link href="/devociones-espiritu" asChild>
            <TouchableOpacity style={styles.menuItem}>
          ...
          <Link href="/devociones-maria" asChild>
            <TouchableOpacity style={styles.menuItem}>
          ...
          <Link href="/devociones-jose" asChild>
            <TouchableOpacity style={styles.menuItem}>
          ...
          <Link href="/devociones-moribundo" asChild>
            <TouchableOpacity style={styles.menuItem}>
              <MaterialCommunityIcons name="heart-pulse" size={32} color={Colors.primary} />
