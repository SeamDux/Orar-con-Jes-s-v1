...
export default function OracionPersecucionScreen() {
  return (
    <>
      <Stack.Screen
        options={{
          title: 'Cristianos que sufren persecución',
          headerStyle: {
      ...
      <ScrollView style={styles.container}>
        <View style={styles.content}>
          <View style={styles.headerCard}>
            <Text style={styles.mainTitle}>Por los cristianos que sufren persecución</Text>
          </View>
