...
export default function OracionAniversariosMatrimonialesScreen() {
  return (
    <>
      <Stack.Screen
        options={{
          title: 'Aniversarios matrimoniales',
          headerStyle: {
      ...
      <ScrollView style={styles.container}>
        <View style={styles.content}>
          <View style={styles.headerCard}>
            <Text style={styles.mainTitle}>Para aniversarios matrimoniales</Text>
          </View>
